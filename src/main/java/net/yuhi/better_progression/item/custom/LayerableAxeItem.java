...
public class LayerableAxeItem extends AxeItem implements LayerableItem {
    public LayerableAxeItem(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
