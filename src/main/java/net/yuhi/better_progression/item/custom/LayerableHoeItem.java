...
public class LayerableHoeItem extends HoeItem implements LayerableItem {
    public LayerableHoeItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
