...
public class BetterFurnaceBlock extends AbstractFurnaceBlock {
    public BetterFurnaceBlock(Properties pProperties) {
        super(pProperties);
    }
    ...
    protected void openContainer(Level pLevel, BlockPos pPos, Player pPlayer) {
        ...
        if (blockentity instanceof BetterFurnaceBlockEntity) {
    ...
    public BlockEntity newBlockEntity(BlockPos pPos, BlockState pState) {
        return ModBlockEntities.BETTER_FURNACE.get().create(pPos, pState);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(Level pLevel, BlockState pState, BlockEntityType<T> pBlockEntityType) {
        return createBetterFurnaceTicker(pLevel, pBlockEntityType, ModBlockEntities.BETTER_FURNACE.get());
    }
