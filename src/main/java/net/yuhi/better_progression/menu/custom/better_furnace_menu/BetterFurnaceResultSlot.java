...
public class BetterFurnaceResultSlot extends Slot {
    ...
    public BetterFurnaceResultSlot(Player pPlayer, Container pContainer, int pSlot, int pXPosition, int pYPosition) {
    ...
    protected void checkTakeAchievements(ItemStack pStack) {
        ...
        if (this.player instanceof ServerPlayer && this.container instanceof AbstractBetterFurnaceBlockEntity) {
            ((AbstractBetterFurnaceBlockEntity)this.container).awardUsedRecipesAndPopExperience((ServerPlayer)this.player);
        }
